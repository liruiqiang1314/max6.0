...
<section>
 ...
 <div class="panel panel-default">
         <div class="panel-heading" style="border-bottom:none;">
              <div>
              <a class="btn btn-primary" href="<?php echo url('console/Infolist/create'); ?>" style="float:right;">添加</a> 
              </div>
...
<th>排序</th>
              ...
              <tbody>
                    <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><div class="ckbox ckbox-primary"><input type="checkbox" id="checkbox<?php echo $vo['id']; ?>" name="checkid[]" value="<?php echo $vo['id']; ?>" /><label for="checkbox<?php echo $vo['id']; ?>"><?php echo $vo['id']; ?></label></div></td>
<td><?php echo $vo['title']; ?></td>
<td><?php echo show_title($vo['classid'],'infoclass'); ?></td>
<td><?php echo show_img($vo['picurl']); ?></td>
<td><?php echo substr($vo['intro'],0,30); ?>...</td>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_10135__=1;$__FOR_END_10135__=9;for($i=$__FOR_START_10135__;$i < $__FOR_END_10135__;$i+=1){ ?>
