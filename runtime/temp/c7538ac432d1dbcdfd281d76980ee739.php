...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>导航名称：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="导航名称" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>上级导航：</label>
            <div class="col-sm-6">
                <select class="select2" name="parentid" required>
                      <option value="0">一级分类</option>
                      <?php if(is_array($nav) || $nav instanceof \think\Collection): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                           <option value="<?php echo $nav['id']; ?>"><?php echo $nav['title']; ?></option>
                      <?php endforeach; endif; else: echo "" ;endif; ?>
                  </select> 
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>导航链接：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="导航链接" name="url" value="<?php echo isset($vo['url']) ? $vo['url'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_22859__=1;$__FOR_END_22859__=9;for($i=$__FOR_START_22859__;$i < $__FOR_END_22859__;$i+=1){ ?>
