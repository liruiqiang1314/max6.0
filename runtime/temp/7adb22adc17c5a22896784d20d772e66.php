<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"E:\project2017\thinkphp5\public/../application/console\view\authgroup\create.html";i:1484806571;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\create.html";i:1485224509;s:81:"E:\project2017\thinkphp5\public/../application/console\view\template\sidebar.html";i:1485157011;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\topbar.html";i:1485158133;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\footer.html";i:1485227663;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
    ...
    <div class="leftpanelinner">
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket mb30">
              ...
              <li><a href="#" onClick="logout('<?php echo url('Console/login/logout'); ?>');"><i class="fa fa-sign-out"></i> <span>退出</span></a></li>
            </ul>
        </div>
          ...
          <li>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li><a href="#" onClick="logout('<?php echo url('Console/login/logout'); ?>');"><i class="fa fa-sign-out"></i> 退出</a></li>
              </ul>
            </div>
          </li>
        </ul>
...
<div class="panel panel-default">
        ...
        <form class="form-horizontal form-bordered" id="submitForm" action="" method="post" >
         <div class="form-group">
            <label class="col-sm-3 control-label"><span class="c-red">*</span>管理组名称：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="管理组名称" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>" required="">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">管理组描述：</label>
            <div class="col-sm-6">
                <textarea class="form-control" placeholder="管理组描述" name="description" ><?php echo isset($vo['description']) ? $vo['description'] :  ''; ?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="panel-footer">
             <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <input type="hidden" name="rules" value="<?php echo isset($vo['rules']) ? $vo['rules'] :  ''; ?>">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_23989__=1;$__FOR_END_23989__=9;for($i=$__FOR_START_23989__;$i < $__FOR_END_23989__;$i+=1){ ?>
