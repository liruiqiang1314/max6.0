...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="电话" name="mobile" value="<?php echo isset($vo['mobile']) ? $vo['mobile'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">内容：</label>
            <div class="col-sm-6">
                <textarea class="form-control" placeholder="" name="content" ><?php echo isset($vo['content']) ? $vo['content'] :  ''; ?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">Ip：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="Ip" name="ip" value="<?php echo isset($vo['ip']) ? $vo['ip'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">回复：</label>
            <div class="col-sm-6">
                <textarea class="form-control" placeholder="" name="rebody" ><?php echo isset($vo['rebody']) ? $vo['rebody'] :  ''; ?></textarea>
            </div>
        </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_331__=1;$__FOR_END_331__=9;for($i=$__FOR_START_331__;$i < $__FOR_END_331__;$i+=1){ ?>
