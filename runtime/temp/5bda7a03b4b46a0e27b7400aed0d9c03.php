<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"E:\project2017\thinkphp5\public/../application/console\view\authgroup\setup.html";i:1484808372;s:78:"E:\project2017\thinkphp5\public/../application/console\view\template\base.html";i:1485224502;s:81:"E:\project2017\thinkphp5\public/../application/console\view\template\sidebar.html";i:1485229266;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\topbar.html";i:1485229261;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\footer.html";i:1488519734;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="" method="post" >
              <div class="form-group">
                  ...
                  <div class="col-sm-6"><label class="control-label"><?php echo isset($acldata['title']) ? $acldata['title'] :  ''; ?>[<?php echo isset($acldata['description']) ? $acldata['description'] :  ''; ?>]</label>
                  </div>
              </div>
              <div class="form-group">
               ...
               <?php if(is_array($acl_list) || $acl_list instanceof \think\Collection): if( count($acl_list)==0 ) : echo "" ;else: foreach($acl_list as $ke=>$vo): ?>   
                <div class="form-group">
                      <label class="col-sm-3 control-label"><?php echo $vo['low_title']['0']; ?>：</label>
                      <div class="col-sm-9">
                            <div class="col-sm-12 whh-inline">
                                <div class="ckbox ckbox-warning checkbox-inline" style="padding-top:0;">
                                        <input type="checkbox" onClick="select_all(this,1);" id="fa<?php echo $ke; ?>"/>
                                        <label for="fa<?php echo $ke; ?>">全选</label>
                                </div>
                            </div>

                                     <?php if(is_array($vo['low_leve']) || $vo['low_leve'] instanceof \think\Collection): if( count($vo['low_leve'])==0 ) : echo "" ;else: foreach($vo['low_leve'] as $fmodel=>$vs): if(is_array($vs) || $vs instanceof \think\Collection): if( count($vs)==0 ) : echo "" ;else: foreach($vs as $keyname=>$acitem): if($keyname != 'data'): ?>
                                          <br/>

                                           <div class="col-sm-12 whh-inline">
                                              <div class="col-sm-3 whh-inline">
                                               <div class="ckbox ckbox-success checkbox-inline" style="padding-top:0;">
                                                    <input type="checkbox" onClick="select_all(this,2);" id="<?php echo $fmodel; ?>"/>
                                                    <label for="<?php echo $fmodel; ?>"><?php echo $keyname; ?>：</label>
                                               </div>
                                             </div>
                                             <div class="col-sm-8 whh-inline">
                                              <?php if(is_array($acitem['1']) || $acitem['1'] instanceof \think\Collection): if( count($acitem['1'])==0 ) : echo "" ;else: foreach($acitem['1'] as $itemname=>$itemkey): ?>  
                                               <div class="ckbox ckbox-primary checkbox-inline" style="padding-top:0;">
                                                  <input type="checkbox" name="model[<?php echo $fmodel; ?>][]" <?php if((isset($acldata['rules'][$fmodel])) AND (array_keys($acldata['rules'][$fmodel],$itemkey))): ?>checked="checked" <?php endif; ?> class="check" value="<?php echo $itemkey; ?>" id="<?php echo $fmodel; ?><?php echo $itemkey; ?>" />
                                                 <label for="<?php echo $fmodel; ?><?php echo $itemkey; ?>"><?php echo $itemname; ?></label>
                                              </div><!-- rdio -->
                                               <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </div>
                                          </div>
                ...
                <?php endforeach; endif; else: echo "" ;endif; ?>   
                   ...
                   <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                      <input type="hidden" name="id" value="<?php echo isset($acldata['id']) ? $acldata['id'] :  ''; ?>">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_2036__=1;$__FOR_END_2036__=9;for($i=$__FOR_START_2036__;$i < $__FOR_END_2036__;$i+=1){ ?>
