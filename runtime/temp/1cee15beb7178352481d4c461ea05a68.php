<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\project2017\mx1.0\public/../application/home\view\login\index.html";i:1492495402;s:68:"E:\project2017\mx1.0\public/../application/home\view\public\top.html";i:1492495898;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div class="layout">
    ...
    <div class="register-box">
      <form action="" method="post" class="am-form" data-am-validator>
        <fieldset>
          <legend>账号登录<p class="register-info">使用手机登录，但是仔细核对后，填入正确信息。</p></legend>
          ...
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="text" name="username" placeholder="请输入手机号" pattern="^1(3[0-9]|4[57]|5[0-35-9]|7[0135678]|8[0-9])\d{8}$" required/>
              </div>
            </div>
          </div>
          ...
          <div class="am-form-group">
            <div class="am-g">
              ...
              <div class="am-u-md-10">
                <input type="password" name="password" placeholder="6位数字的密码" pattern="^\d{6}$" required/>
              </div>
            </div>
          </div>
