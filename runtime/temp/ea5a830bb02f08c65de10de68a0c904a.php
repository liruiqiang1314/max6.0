<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\project2017\mx1.0\public/../application/home\view\infolist\index.html";i:1492676022;s:69:"E:\project2017\mx1.0\public/../application/home\view\public\base.html";i:1492675278;s:68:"E:\project2017\mx1.0\public/../application/home\view\public\top.html";i:1492495898;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<link rel="stylesheet" href="__HOME__/css/news.min.css" />
      ...
      <div class="container">
        ...
        <div class="news-contaier">
          <div class="blog">
            ...
            <div class="am-u-lg-4 am-u-md-6" style="float: left;">
                <div class="article">
                  <div class="article-img">
                    <img src="__ROOT__<?php echo $vo['picurl']; ?>" alt="<?php echo $vo['title']; ?>" width="360px" height="220px" />
                  </div>
                  <div class="article-header">
                    <h2><a href="<?php echo url('home/infolist/show',['id'=>$vo['id']]); ?>" rel=""><?php echo $vo['title']; ?></a></h2>
                    <ul class="article--meta">
            						<li class="article--meta_item -date"><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></li>
            					</ul>
                  </div>
                  <div class="article--content">
          						<p style="height: 92px;overflow-y: hidden;"><?php echo $vo['intro']; ?></p>
          					</div>
                  <div class="article--footer">
          						<a href="<?php echo url('home/infolist/show',['id'=>$vo['id']]); ?>" class="link">更多</a>
          					</div>
                </div>
              </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>     
