...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>地方：</label>
            <div class="col-sm-6 wh-inline">
                <div class="rdio rdio-primary">
                    <input type="radio" name="tu" id="tu-1" value="1" required>
                    <label for="tu-1">男</label>
                </div>
                <div class="rdio rdio-primary">
                    <input type="radio" name="tu" id="tu-2" value="2" required>
                    <label for="tu-2">女</label>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6 wh-inline">
                <div class="ckbox ckbox-primary">
                    <input type="checkbox" name="gg[]" id="gg-1" value="1">
                    <label for="gg-1">男</label>
                </div>
                <div class="ckbox ckbox-primary">
                    <input type="checkbox" name="gg[]" id="gg-2" value="2">
                    <label for="gg-2">女</label>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    $("[name='tu'][value='<?php echo isset($vo['tu']) ? $vo['tu'] :  '1'; ?>']").attr("checked", true);
    var checks = '1'.split(",");
    if (checks.length > 0){
        for (var i in checks){
            $("[name='gg[]'][value='"+checks[i]+"']").attr("checked", true);
        }
    }
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_24385__=1;$__FOR_END_24385__=9;for($i=$__FOR_START_24385__;$i < $__FOR_END_24385__;$i+=1){ ?>
