<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"E:\project2017\thinkphp5\public/../application/console\view\lijinfeng\create.html";i:1484635591;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\create.html";i:1484211528;s:81:"E:\project2017\thinkphp5\public/../application/console\view\template\sidebar.html";i:1484041788;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\topbar.html";i:1484041780;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\footer.html";i:1483681348;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label">的：</label>
            <div class="col-sm-6">
                <textarea class="form-control" placeholder="" name="con" ><?php echo isset($vo['con']) ? $vo['con'] :  ''; ?></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>公司：</label>
            <div class="col-sm-6">
                    <select name="conpd" class="select2" required>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="时间" name="time" value="<?php echo isset($vo['time']) ? $vo['time'] :  ''; ?>"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" >
            </div>
        </div>
...
$(document).ready(function() {
    $("[name='sex'][value='<?php echo isset($vo['sex']) ? $vo['sex'] :  '2'; ?>']").attr("checked", true);
    ...
    $("[name='conpd']").find("[value='<?php echo isset($vo['conpd']) ? $vo['conpd'] :  '2'; ?>']").attr("selected", true);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_1120__=1;$__FOR_END_1120__=9;for($i=$__FOR_START_1120__;$i < $__FOR_END_1120__;$i+=1){ ?>
