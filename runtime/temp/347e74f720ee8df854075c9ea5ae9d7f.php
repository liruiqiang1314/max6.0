<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\project2017\mx1.0\public/../application/home\view\product\index.html";i:1492669535;s:69:"E:\project2017\mx1.0\public/../application/home\view\public\base.html";i:1492675278;s:68:"E:\project2017\mx1.0\public/../application/home\view\public\top.html";i:1492495898;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<link rel="stylesheet" href="__HOME__/css/solution.min.css" />
        ...
        <div class="solution-container">
          <div data-am-widget="tabs" class="am-tabs ">
              <ul class="am-tabs-nav am-cf">
                  ...
                  <li class="<?php if($i == 1): ?> am-active <?php endif; ?>"><a href="[data-tab-panel-<?php echo $vo['id']; ?>]"><?php echo $vo['title']; ?></a></li>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
              <div class="am-tabs-bd">
              <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
              <div data-tab-panel-<?php echo $vo['id']; ?> class="am-tab-panel <?php if($i == 1): ?> am-active <?php endif; ?>">
                 <div class="am-g">
                   <?php if(is_array($vo['list']) || $vo['list'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                   <div class="am-u-md-4 am-u-sm-6" style="float: left;">
                   <div class="features_item">
                      <a href="<?php echo url('home/product/show',['id'=>$vo1['id']]); ?>"><img src="__ROOT__<?php echo $vo1['picurl']; ?>" alt="<?php echo $vo1['title']; ?>" width="260px" height="200px"></a>
                      <h3 class="features_item--title"><a href="<?php echo url('home/product/show',['id'=>$vo1['id']]); ?>"><?php echo $vo1['title']; ?></a></h3>
                    </div>
