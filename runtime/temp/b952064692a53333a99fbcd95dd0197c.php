    ...
    <div class="contentpanel">
      ...
      <div class="row">
        ...
        <div class="tab-content mb30">
          <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;switch($vo['id']): case "5": ?>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_32243__=1;$__FOR_END_32243__=9;for($i=$__FOR_START_32243__;$i < $__FOR_END_32243__;$i+=1){ ?>
