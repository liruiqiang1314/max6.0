...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>编码：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="编码" name="code" value="<?php echo isset($vo['code']) ? $vo['code'] :  ''; ?>"  required readonly>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>名称：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="名称" name="name" value="<?php echo isset($vo['name']) ? $vo['name'] :  ''; ?>"  required>
            </div>
        </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_2258__=1;$__FOR_END_2258__=9;for($i=$__FOR_START_2258__;$i < $__FOR_END_2258__;$i+=1){ ?>
