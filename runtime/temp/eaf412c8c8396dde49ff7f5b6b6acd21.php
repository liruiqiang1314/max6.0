<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\project2017\thinkphp5\public/../application/home\view\.\reg.html";i:1488439174;s:66:"E:\project2017\thinkphp5\public/../application/home\view\base.html";i:1491456291;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="main_bg">
	<div class="content">
		<div class="vip_tit tc">会员<span>中心</span></div>
		<form action="" method="post" class="vip">
			<p><label for="">会员名：</label><input type="text" class="vip_bd"><span>*</span></p>
			<p><label for="">密　码：</label><input type="password" class="vip_bd"><span>*</span></p>
			<p><label for="">确认密码：</label><input type="password" class="vip_bd"><span>*</span></p>
			<p><label for="">真实姓名：</label><input type="text" class="vip_bd"><span>*</span></p>
			<p><label for="">联系电话：</label><input type="text" class="vip_bd"></p>
			<p><label for="">电子邮箱：</label><input type="text" class="vip_bd"></p>
			<p><label for="">验证码：</label><input type="text" class="vip_bd yzm"></p>			
			<p><label for=""></label>
			<input type="submit" value="注　册" class="btn btn1"/>
			<input type="reset" value="重　置" class="btn btn2"></p>
		</form>
	</div>
</div>
