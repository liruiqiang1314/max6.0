        ...
        <div class="panel-body panel-body-nopadding">
              <form class="form-horizontal form-bordered" id="submitForm" action="" method="post" > 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" placeholder="销售价格" name="saleprice" value="<?php echo isset($vo['saleprice']) ? $vo['saleprice'] :  ''; ?>"  required>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">属性组<?php if(isset($vo)): ?><a href="<?php echo url('console/goods/show',['id'=>$vo['id']]); ?>" target="_blank">预览</a><?php endif; ?>：</label>
                        <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                    ...
                                    <span id="attrs<?php echo $k-1; ?>_area">
                                        <?php if(is_array($voa['attrs']) || $voa['attrs'] instanceof \think\Collection): $i = 0; $__LIST__ = $voa['attrs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voas): $mod = ($i % 2 );++$i;?>
                                          <input type="checkbox" name="attrs<?php echo $k-1; ?>[]" onchange="descates();" value="<?php echo $voas; ?>" checked><?php echo $voas; endforeach; endif; else: echo "" ;endif; ?>
                                    </span>
                              </div>
                            </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_17199__=1;$__FOR_END_17199__=9;for($i=$__FOR_START_17199__;$i < $__FOR_END_17199__;$i+=1){ ?>
