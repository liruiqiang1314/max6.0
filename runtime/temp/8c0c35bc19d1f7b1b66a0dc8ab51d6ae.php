...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="url" class="form-control" placeholder="跳转链接" name="linkurl" value="<?php echo isset($vo['linkurl']) ? $vo['linkurl'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
...
$(document).ready(function() {
    ...
    $("[name='target'][value='<?php echo isset($vo['target']) ? $vo['target'] :  '_self'; ?>']").attr("checked", true);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_6078__=1;$__FOR_END_6078__=9;for($i=$__FOR_START_6078__;$i < $__FOR_END_6078__;$i+=1){ ?>
