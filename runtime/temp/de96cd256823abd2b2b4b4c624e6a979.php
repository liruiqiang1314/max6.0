...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>名字：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="名字" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">内容：</label>
            <div class="col-sm-6">
                <textarea class="form-control" placeholder="" name="congtent" id="container"><?php echo isset($vo['congtent']) ? $vo['congtent'] :  ''; ?></textarea>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <input type="hidden" id="picurl" placeholder="订单" name="picurl" value="<?php echo isset($vo['picurl']) ? $vo['picurl'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">收到：</label>
            <div class="col-sm-6">
                    <select name="ff" class="select2">
...
$(document).ready(function() {
    ...
    $("[name='ff']").find("[value='<?php echo isset($vo['ff']) ? $vo['ff'] :  '2'; ?>']").attr("selected", true);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_20227__=1;$__FOR_END_20227__=9;for($i=$__FOR_START_20227__;$i < $__FOR_END_20227__;$i+=1){ ?>
