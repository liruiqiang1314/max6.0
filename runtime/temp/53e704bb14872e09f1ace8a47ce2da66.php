...
<section>
 ...
 <div class="panel panel-default">
         <div class="panel-heading" style="border-bottom:none;">
              <div>
              <!-- <a class="btn btn-primary" href="<?php echo url('console/CnArea/create'); ?>" style="float:right;">添加</a> --> 
              </div>
...
<td><?php echo renew_field($vo['name'],$vo['id'],'name'); ?></td>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_25607__=1;$__FOR_END_25607__=9;for($i=$__FOR_START_25607__;$i < $__FOR_END_25607__;$i+=1){ ?>
