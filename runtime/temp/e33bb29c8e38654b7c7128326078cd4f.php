<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"E:\project2017\thinkphp5\public/../application/console\view\banner\index.html";i:1485306509;s:79:"E:\project2017\thinkphp5\public/../application/console\view\template\index.html";i:1485224515;s:81:"E:\project2017\thinkphp5\public/../application/console\view\template\sidebar.html";i:1485229266;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\topbar.html";i:1485229261;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\footer.html";i:1485227663;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
...
<section>
 ...
 <ul class="filemanager-options">
        ...
        <li>
          <a onClick="check_delete('<?php echo url('console/banner/delete'); ?>',0);" class="itemopt disabled"><i class="fa fa-trash-o"></i> 删除</a>
        </li>
      ...
      <div class="row">
              ...
              <div class="thmb">
                ...
                <div class="btn-group fm-group">
                    ...
                    <ul class="dropdown-menu fm-menu" role="menu">
                      <li><a href="<?php echo url('console/banner/update', ['id' => $vo['id']]); ?>"><i class="fa fa-pencil"></i> 编辑</a></li>
                      <li><a onClick="check_delete('<?php echo url('console/banner/delete'); ?>',<?php echo $vo['id']; ?>);"><i class="fa fa-trash-o"></i> 删除</a></li>
                    </ul>
                </div><!-- btn-group -->
                <div class="thmb-prev">
                   <a href="__ROOT__<?php echo $vo['picurl']; ?>" data-rel="prettyPhoto">
                    <img src="__ROOT__<?php echo $vo['picurl']; ?>" class="img-responsive" alt="<?php echo $vo['title']; ?>" style="height:200px;" />
                  </a>
                </div>
                <h5 class="fm-title"><a href="<?php echo url('console/banner/update', ['id' => $vo['id']]); ?>"><?php echo $vo['title']; ?></a></h5>
        ...
        <div class="col-sm-3">
          <div class="fm-sidebar">
            ...
            <a href="<?php echo url('console/banner/create'); ?>" class="btn btn-primary btn-block">添加banner</a>
            
            <div class="mb30"></div>
            
            <h5 class="subtitle"><a href="<?php echo url('console/banner/index'); ?>">全部分类</a> <a href="#" class="pull-right" data-toggle="modal" data-target=".bs-example-modal-lg">+ 创建分类</a></h5>
                ...
                <table class="table">
                    ...
                    <?php if(is_array($type) || $type instanceof \think\Collection): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vot): $mod = ($i % 2 );++$i;?>
                        <tr <?php if($tid == $vot['id']): ?> style="background-color:#BCBCBC;" <?php endif; ?>>
                            <td width="60%"><a href="<?php echo url('console/banner/index', ['tid' => $vot['id']]); ?>" style="text-decoration:none;"><i class="fa fa-search"></i><span><?php echo $vot['title']; ?></span></a></td>
                            <td width="40%" style="text-align: right;">
                            <a href="<?php echo url('console/bannerType/update', ['id' => $vot['id']]); ?>"><i class="fa fa-pencil"></i> 
                            <a onClick="check_delete('<?php echo url('console/bannerType/delete'); ?>',<?php echo $vot['id']; ?>);"><i class="fa fa-trash-o"></i> </a>
                            </td>
                        </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form class="form-horizontal form-bordered" id="submitForm" action="<?php echo url('console/bannerType/create'); ?>" method="post" >
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input type="text" class="form-control" placeholder="排序" name="orderid" value="<?php echo get_orderid('','orderid','banner_type'); ?>" >
                              </div>
                          </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_31899__=1;$__FOR_END_31899__=9;for($i=$__FOR_START_31899__;$i < $__FOR_END_31899__;$i+=1){ ?>
