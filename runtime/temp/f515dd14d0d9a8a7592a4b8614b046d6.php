<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\project2017\thinkphp5\public/../application/home\view\.\login.html";i:1488439068;s:66:"E:\project2017\thinkphp5\public/../application/home\view\base.html";i:1491456291;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="main_bg">
	<div class="content">
		<div class="vip_tit tc">会员<span>信息</span></div>
		<form action="" method="post" class="vip">
			<p><label for="">账　号：</label><input type="text" class="vip_bd"><span>*</span></p>
			...
			<p><label for=""></label><input type="submit" value="登    录" class="btn btn1 btn3"/><input type="reset" value="注　册" class="btn btn2 btn3"><a href="" class="paw">找回密码</a></p>
		</form>
	</div>
</div>
