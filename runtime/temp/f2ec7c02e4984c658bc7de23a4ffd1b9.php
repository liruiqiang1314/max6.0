...
<td><?php echo renew_field($vo['title'],$vo['id'],'title'); ?></td>
<td><?php echo renew_field($vo['url'],$vo['id'],'url'); ?></td>
<td><?php echo show_status($vo['status'],$vo['id']); ?></td>
<td><?php echo renew_field($vo['orderid'],$vo['id'],'orderid'); ?></td>
                                <td>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_4832__=1;$__FOR_END_4832__=9;for($i=$__FOR_START_4832__;$i < $__FOR_END_4832__;$i+=1){ ?>
