...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="number" class="form-control" placeholder="人数" name="num" value="<?php echo isset($vo['num']) ? $vo['num'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_25072__=1;$__FOR_END_25072__=9;for($i=$__FOR_START_25072__;$i < $__FOR_END_25072__;$i+=1){ ?>
