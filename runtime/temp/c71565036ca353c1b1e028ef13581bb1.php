  ...
  <div class="mainpanel">
    ...
    <div class="panel panel-default">
         <div class="panel-heading" style="border-bottom:none;">
              <div>
              <a class="btn btn-primary" href="<?php echo url('Console/Manager/create'); ?>" style="float:right;">添加</a> 
              </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="table1">
              ...
              <tbody>
                 <?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            <td><div class="ckbox ckbox-primary"><input type="checkbox" id="checkbox<?php echo $vo['id']; ?>" name="checkid[]" value="<?php echo $vo['id']; ?>" />
                                            <label for="checkbox<?php echo $vo['id']; ?>"><?php echo $vo['id']; ?></label></div></td>
                                            <td><?php echo renew_field($vo['username'],$vo['id'],'username'); ?></td>
                                            <td><?php echo renew_field($vo['nickname'],$vo['id'],'nickname'); ?></td>
                                            <td><?php echo renew_field($vo['mobile'],$vo['id'],'mobile'); ?></td>
                                            <td><?php echo show_title($vo['group_id'],'authgroup'); ?></td>
             ...
             <div class="form-inline">
                  ...
                  <?php echo show_operate('0','delete','删 除'); ?> <!-- 全选删除   -->                   
                </div>
              <!-- end-deleteArea -->
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_22295__=1;$__FOR_END_22295__=9;for($i=$__FOR_START_22295__;$i < $__FOR_END_22295__;$i+=1){ ?>
