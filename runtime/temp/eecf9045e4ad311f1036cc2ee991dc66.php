...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>网址：</label>
            <div class="col-sm-6">
                <input type="url" class="form-control" placeholder="网址" name="url" value="<?php echo isset($vo['url']) ? $vo['url'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="排序" name="orderid" value="<?php echo get_orderid(\think\Request::instance()->param('id')); ?>"  required>
            </div>
        </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_15394__=1;$__FOR_END_15394__=9;for($i=$__FOR_START_15394__;$i < $__FOR_END_15394__;$i+=1){ ?>
