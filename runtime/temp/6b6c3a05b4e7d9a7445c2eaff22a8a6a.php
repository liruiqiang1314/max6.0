<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\project2017\mx1.0\public/../application/home\view\contact\index.html";i:1492508818;s:69:"E:\project2017\mx1.0\public/../application/home\view\public\base.html";i:1492675278;s:68:"E:\project2017\mx1.0\public/../application/home\view\public\top.html";i:1492495898;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<link rel="stylesheet" href="__HOME__/css/contact.min.css" />
              ...
              <ul class="contact-left">
                <li class="contact-box-item">
                  <div class="contact_item">
                    ...
                    <h3 class="contact_item--title">热线</h3>
                    <p class="contact_item--text">
                      <strong><?php echo \think\Config::get('web_config.web_hotline'); ?></strong>,
                      <br> <?php echo \think\Config::get('web_config.web_hotline_more'); ?>
                    </p>
                  </div>
                </li>
                <li class="contact-item">
                  <div class="contact_item">
                    ...
                    <p class="contact_item--text">
                      <?php echo \think\Config::get('web_config.web_email'); ?>
                       <br/><?php echo \think\Config::get('web_config.web_email_more'); ?>
                    </p>
                  </div>
                </li>
                <li class="contact-item">
                  <div class="contact_item">
                    ...
                    <p class="contact_item--text">
                      <?php echo \think\Config::get('web_config.web_address'); ?>
                       <br/><?php echo \think\Config::get('web_config.web_address_more'); ?>
                    </p>
                  </div>
                </li>
              </ul>
              ...
              <div class="am-u-md-7">
                <div class="contact-form">
                  ...
                  <form action="" method="post" class="am-form">
                    <div class="am-g">
                      <div class="am-u-md-6">
                        <input type="text" class="" name="truename" placeholder="姓名" required>
                      </div>
                      <div class="am-u-md-6">
                        <input type="text" class="" name="mobile" placeholder="电话" required pattern="^1[3|4|5|8][0-9]\d{4,8}$">
                      </div>
                    </div>
                    ...
                    <div class=am-g>
                      <div class="am-u-md-12">
                        <div class="am-form-group">
                          <textarea class="" rows="5" name="content" placeholder="写下你想说的..." required></textarea>
                        </div>
                      </div>
                    </div>
