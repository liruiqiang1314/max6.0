<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"E:\project2017\thinkphp5\public/../application/console\view\product\create.html";i:1484803464;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\create.html";i:1491358283;s:81:"E:\project2017\thinkphp5\public/../application/console\view\template\sidebar.html";i:1485229266;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\topbar.html";i:1485229261;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\footer.html";i:1488519734;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="标题" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>"  required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
               ...
               <input type="hidden" id="picurl" name="picurl" value="<?php echo isset($vo['picurl']) ? $vo['picurl'] :  ''; ?>">
              </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
             ...
             <?php if(isset($vo)): if(is_array($vo['picarr']) || $vo['picarr'] instanceof \think\Collection): $i = 0; $__LIST__ = $vo['picarr'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vop): $mod = ($i % 2 );++$i;?>
                   <input type="hidden" value="<?php echo $vop['img']; ?>" name="picimg[]" flag="<?php echo $vop['info']; ?>" show="<?php echo $vop['show']; ?>" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <textarea class="form-control" placeholder="" name="content" id="container"><?php echo isset($vo['content']) ? $vo['content'] :  ''; ?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">关键词：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="关键词" name="keyword" value="<?php echo isset($vo['keyword']) ? $vo['keyword'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="number" class="form-control" placeholder="排序" name="orderid" value="<?php echo get_orderid(\think\Request::instance()->param('id')); ?>" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6"><label class="control-label"><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></label>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">上次更新：</label>
            <div class="col-sm-6"><label class="control-label"><?php echo date('Y-m-d H:i:s',$vo['update_time']); ?></label>
            </div>
        </div>
       <?php endif; ?> 
...
$(document).ready(function() {
    ...
    $("[name='type_id']").find("[value='<?php echo isset($vo['type_id']) ? $vo['type_id'] :  ''; ?>']").attr("selected", true);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_29437__=1;$__FOR_END_29437__=9;for($i=$__FOR_START_29437__;$i < $__FOR_END_29437__;$i+=1){ ?>
