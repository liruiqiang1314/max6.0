...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="title" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>picurl：</label>
            <div class="col-sm-6">
                <input id="fileone" type="file" class="file-loading">
                <input type="hidden" id="picurl" placeholder="picurl" name="picurl" value="<?php echo isset($vo['picurl']) ? $vo['picurl'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>date：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="date" name="nowtime" value="<?php echo isset($vo['nowtime']) ? $vo['nowtime'] :  ''; ?>"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>状态：</label>
            <div class="col-sm-6 wh-inline">
                <div class="rdio rdio-primary">
                    <input type="radio" name="status" id="status-1" value="1" required>
                    <label for="status-1">启用</label>
                </div>
                <div class="rdio rdio-primary">
                    <input type="radio" name="status" id="status-0" value="0" required>
...
<script src="__PLUGIN__/Fileinput/js/plugins/canvas-to-blob.min.js"></script>
<script src="__PLUGIN__/Fileinput/js/plugins/purify.min.js"></script>
<script src="__PLUGIN__/Fileinput/js/plugins/sortable.min.js"></script>
<script>
//单图上传
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_8862__=1;$__FOR_END_8862__=9;for($i=$__FOR_START_8862__;$i < $__FOR_END_8862__;$i+=1){ ?>
