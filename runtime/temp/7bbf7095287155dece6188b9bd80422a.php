...
<div class="panel panel-default">
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label"><span>*</span>头像：</label>
            <div class="col-sm-6">
                <input id="fileone" type="file" class="file-loading">
                <input type="hidden" id="picurl" placeholder="头像" name="picurl" value="<?php echo isset($vo['picurl']) ? $vo['picurl'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_12731__=1;$__FOR_END_12731__=9;for($i=$__FOR_START_12731__;$i < $__FOR_END_12731__;$i+=1){ ?>
