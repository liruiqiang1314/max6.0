<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\project2017\mx1.0\public/../application/home\view\infolist\show.html";i:1492503237;s:69:"E:\project2017\mx1.0\public/../application/home\view\public\base.html";i:1492675278;s:68:"E:\project2017\mx1.0\public/../application/home\view\public\top.html";i:1492495898;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <div class="am-u-md-9">
          <div class="article">
            <header class="article--header">
              <h2 class="article--title"><a><?php echo $voo['title']; ?></a></h2>
              <ul class="article--meta">
                <li class="article--meta_item"><i class="am-icon-calendar"></i><?php echo date('Y-m-d H:i:s',$voo['create_time']); ?></li>
              </ul>
            </header>
            <div class="article--content">
              <?php echo $voo['content']; ?>
            </div>
          </div>
        </div>
          ...
          <div class="blog_sidebar">
            <div class="widget">
              ...
              <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                  <li><a href="<?php echo url('home/infolist/show',['id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a></li>
              <?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div>
          </div>
