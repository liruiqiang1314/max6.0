<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\project2017\mx1.0\public/../application/home\view\solution\index.html";i:1492673149;s:69:"E:\project2017\mx1.0\public/../application/home\view\public\base.html";i:1492675278;s:68:"E:\project2017\mx1.0\public/../application/home\view\public\top.html";i:1492495898;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
      ...
      <div class="container">
        ...
        <div class="o2o-container">
          ...
          <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="am-u-lg-3" style="float: left;">
              <div class="o2o-box"  style="text-align:center">
                <a href="<?php echo url('home/solution/show',['id'=>$vo['id']]); ?>">
                <img src="__ROOT__<?php echo $vo['picurl']; ?>" alt="<?php echo $vo['title']; ?>" width="100px" height="100px" />
                </a>
                <div class="o2o-content">
                  <h3 style="text-align: center;margin-top:20px;"><a href="<?php echo url('home/solution/show',['id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a></h3>
                  <p style="height: 50px;"><?php echo $vo['intro']; ?></p>
                </div>
              </div>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
