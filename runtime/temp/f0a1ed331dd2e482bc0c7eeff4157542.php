<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"E:\project2017\thinkphp5\public/../application/console\view\product_type\create.html";i:1483065311;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\create.html";i:1485156740;s:81:"E:\project2017\thinkphp5\public/../application/console\view\template\sidebar.html";i:1485157011;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\topbar.html";i:1485157054;s:80:"E:\project2017\thinkphp5\public/../application/console\view\template\footer.html";i:1485153528;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
  <meta charset="utf-8">
...
<div class="panel panel-default">
        ...
        <form class="form-horizontal form-bordered" id="submitForm" action="" method="post" >
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="分类名称" name="title" value="<?php echo isset($vo['title']) ? $vo['title'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">描述：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="描述" name="intro" value="<?php echo isset($vo['intro']) ? $vo['intro'] :  ''; ?>" >
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">排序：</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="排序" name="orderid" value="<?php echo get_orderid(\think\Request::instance()->param('id')); ?>" >
            </div>
        </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_15592__=1;$__FOR_END_15592__=9;for($i=$__FOR_START_15592__;$i < $__FOR_END_15592__;$i+=1){ ?>
