...
<section>
 ...
 <div class="panel panel-default">
         <div class="panel-heading" style="border-bottom:none;">
              <div>
              <a class="btn btn-primary" href="<?php echo url('console/Authgroup/create'); ?>" style="float:right;">添加</a> 
              </div>
              ...
              <tbody>
                    <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td>
                                <?php if($vo['id'] != '1'): ?>
                                    <?php echo show_operate($vo['id'],'setup','权 限'); ?>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                <?php endif; ?>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_30774__=1;$__FOR_END_30774__=9;for($i=$__FOR_START_30774__;$i < $__FOR_END_30774__;$i+=1){ ?>
