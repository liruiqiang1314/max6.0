...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="真实姓名" name="truename" value="<?php echo isset($vo['truename']) ? $vo['truename'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="email" class="form-control" placeholder="邮箱" name="email" value="<?php echo isset($vo['email']) ? $vo['email'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <select class="form-control" name="prov" onchange="GetRegion(this.value,1)" required>
                    ...
                    <?php if(is_array($prov_data) || $prov_data instanceof \think\Collection): $i = 0; $__LIST__ = $prov_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$prov_vo): $mod = ($i % 2 );++$i;?>
                          <option value="<?php echo $prov_vo['code']; ?>"><?php echo $prov_vo['name']; ?> </option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
          </div>
          <div class="col-sm-2">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
              <input class="form-control" type="text" name="address" placeholder="详细地址" datatype="*" value="<?php echo isset($vo['address']) ? $vo['address'] :  ''; ?>">
            </div>
        </div>
        <div class="form-group">
        ...
        fields: {
            ...
            username: {
                ...
                validators: {
                    ...
                    remote: {
                        url: "<?php echo url('console/common/validonly',['table'=>'user']); ?>",
                        message: '用户名已经存在'
                    }
...
function GetRegion(val,level){
      ...
      $.ajax({
            type: "post",
            url: "<?php echo url('Console/common/getRegion'); ?>",
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_21013__=1;$__FOR_END_21013__=9;for($i=$__FOR_START_21013__;$i < $__FOR_END_21013__;$i+=1){ ?>
